# Generated by Powerlevel10k configuration wizard on 2020-08-10 at 18:39 CST.
...
# 2 lines, dotted, no frame, light-ornaments, compact, few icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_ADD_NEWLINE=true # estaba en false

  # Connect left prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX=" " # estaba vacío sin nada
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX=
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX=" " # estaba vacío sin nada
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='裂'
	# ❯ ⮞ 🠶 🢖   雷ﮧ 異﬇ 裂ﰙ  

  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='ﱄ'
	# ❮ ⮜ 🠴 🢔

  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='麗'
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=149 # estaba en 31
  # If directory is too long, shorten some of its segments to the shortest possible unique
  # prefix. The shortened directory can be tab-completed to the original.
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_last # estaba en trucate_to_unique
  ...
  typeset -g POWERLEVEL9K_STATUS_OK=false # estaba en false
